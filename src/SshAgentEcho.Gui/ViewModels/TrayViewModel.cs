...
namespace SshAgentEcho.Gui.ViewModels {
    ...
    public partial class TrayViewModel : ObservableObject {
        ...
        public TrayViewModel(SyncService syncService) {
            ...
            StatusText = $"Status: {_syncService.Status}";
            TooltipText = $"ssh-agent-echo - {_syncService.Status}";
        }
        ...
        */
        private void OnSyncStatusChanged(object? sender, SyncServiceArgs e) {
            ...
            Avalonia.Threading.Dispatcher.UIThread.Post(() => {
                ...
                TooltipText = $"ssh-agent-echo - {e.Status}";
